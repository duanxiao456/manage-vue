<template>
    <div class="analysis">
        ...
        <a-card :loading="loading" style="margin-top: 12px" :bordered="false" :body-style="{padding: '24px'}">
            <div class="salesCard">
        ...
        <a-row style="margin: 0 -12px">
            <a-col style="padding: 0 12px" :xl="12" :lg="24" :md="24" :sm="24" :xs="24">
                <a-card :loading="loading" :bordered="false" style="margin-top: 12px" :title="$t('search')">
                    <hot-search/>
                </a-card>
            </a-col>
            <a-col style="padding: 0 12px" :xl="12" :lg="24" :md="24" :sm="24" :xs="24">
                <a-card :loading="loading" :bordered="false" style="margin-top: 12px;" :title="$t('proportion')">
                    <sales-data/>

        ...
        <template>
            <a-row style="margin: 0 -12px">
                <a-col style="padding: 0 12px" :xl="16" :lg="24" :md="24" :sm="24" :xs="24">
                    <a-card class="project-list" :loading="loading" style="margin-bottom: 12px;" :bordered="false"
                ...
                <a-col style="padding: 0 12px" :xl="8" :lg="24" :md="24" :sm="24" :xs="24">
                    <a-card :title="$t('access')" style="margin-bottom: 12px" :bordered="false"
                    ...
                    <a-card :loading="loading" :title="`XX ${$t('degree')}`" style="margin-bottom: 12px"
